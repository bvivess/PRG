...
public class Main {
    ...
    private static void carregaPersones(ArrayList<Persona> persones) {
        ...
        persona = new Persona("Joan", new String[] {"1234", null, null, null});
        persones.add(persona);
        // Persona2
        persona = new Persona("Gemma", new String[] {null, "Teclat2", null, null});
        persones.add(persona);
        // Persona3
        persona = new Persona("Pere", new String[] {null, null, "Emprempta3", null});
        persones.add(persona);
        // Persona4
        persona = new Persona("Maria", new String[] {null, null, null, "Rostre4"});
        persones.add(persona);
    }
    
    private static void carregaTelefons(ArrayList<Telefon> telefons, ArrayList<Persona> persones) {
        Telefon telefon;
        telefon = new Android("Samsung", persones.get(0), new String[] {"1234", null, null, null});
        telefons.add(telefon);
        // Android
        telefon = new Android("Xiaomi", persones.get(1), new String[] {null, "Teclat2", null, null});
        telefons.add(telefon);
        // IPhone8
        telefon = new IPhone8("Apple",persones.get(2), new String[] {null, null, "Emprempta3", null});
        telefons.add(telefon);
        // IPhone10
        telefon = new IPhone10("Apple",persones.get(3), new String[] {null, null, null, "Rostre4"});
        telefons.add(telefon);
    }
