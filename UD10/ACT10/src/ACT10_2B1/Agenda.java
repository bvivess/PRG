...
public class Agenda {
    private Map<String, List<Tasca>> tasques;

    public Agenda() {
        tasques = new TreeMap<>();  // 'TreeMap' ordena el 'Map' per 'key'
    }

    public void afegeixTasca(String data, LocalTime hora, String titol) {
    ...
    public List<Tasca> cercaDia(String data) {
    ...
    public String obteTasca(String data, LocalTime hora) {
        List<Tasca> tasquesEnData = cercaDia(data);
        String titol = "";
        if (tasquesEnData == null)
            titol = null;
    ...
    public String toString() {
        ...
        for (Map.Entry<String, List<Tasca>> entry : this.tasques.entrySet()) {
