...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("=== cercaVehiclesHistorics ===");
            System.out.println(taller.cercaVehiclesHistorics("1234ABC"));
            System.out.println(taller.cercaVehiclesHistorics("AAAAABC"));
        } catch (Exception e) {
