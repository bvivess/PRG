...
public class EX_4 {
    public static void main(String[] args) {
        ...
        // Crea 2 'Array' de 5 posicions amb números aleatoris entre 0 i 9
        ...
        resultat = UtilExamen.ordenaArray( UtilExamen.ArrayListToArray( UtilExamen.obteRepetits(array1, array2) ) );
