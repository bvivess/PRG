...
public class Main {
    ...
    public static void llegeixArxiu(String arxiu, String arxiuLog, Set<Meteorit> meteorits, Map<Integer, List<Meteorit>> meteoritsPerAny) throws IOException {
        ...
        try ( BufferedReader bufferedReader = new BufferedReader(new FileReader(arxiu));
            ...
            while ((linia = bufferedReader.readLine()) != null) {
                try {
                    Meteorit m = parseMeteorit(linia, numLinia++, bufferedWriter, meteorits);
    ...
    private static Meteorit parseMeteorit(String linia, int numLinia, BufferedWriter bufferedWriter, Set<Meteorit> meteorits) {
        Meteorit m;
        if (!(linia.isEmpty() || linia.startsWith("#"))) {
            try {
                ...
                m = new Meteorit(_id, _nom, _type, _massa, _fell, _data, _latitude, _longitude);
                meteorits.add( m );
                return m;
            } catch (NumberFormatException e) {
